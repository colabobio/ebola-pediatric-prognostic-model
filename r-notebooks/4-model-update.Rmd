...
res <- cal_coeff(data, "m2_pred")
res
saveToTXT(res, mdl_folder, "cal_plot_recalibration_on_the_large_coefficients.txt")
```
...
res <- cal_coeff(data, "m3_pred")
res
saveToTXT(res, mdl_folder, "cal_plot_recalibration_logistic_coefficients.txt")
```
...
res
saveToTXT(res, mdl_folder, "cal_plot_validation_with_alt_coefficients.txt")
...
res <- cal_coeff(data, "m2_pred")
res
saveToTXT(res, mdl_folder, "cal_plot_validation_with_ast_coefficients.txt")
...
res <- cal_coeff(data, "m3_pred")
res
saveToTXT(res, mdl_folder, "cal_plot_validation_with_ck_coefficients.txt")
